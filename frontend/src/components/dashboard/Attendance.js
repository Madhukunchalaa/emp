...
const Attendance = () => {
  ...
  // Debug log to see attendance structure
  useEffect(() => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="px-6 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          {/* Current Time */}
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-sm p-6 border border-white/20">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-sm p-5 border border-white/20">
            <div className="flex items-center justify-between mb-3">
              <div className={`p-3 rounded-xl shadow-lg ${
                todayStats.isPresent ? 'bg-gradient-to-r from-green-500 to-emerald-500' : 'bg-gradient-to-r from-red-500 to-pink-500'
              }`}>
