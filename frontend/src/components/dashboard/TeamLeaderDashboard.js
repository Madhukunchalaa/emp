    ...
    <div className="min-h-screen flex bg-gray-100">
      ...
      <div className="flex-1 ml-0 md:ml-64 min-h-screen flex flex-col">
        ...
        <div className="px-6 py-6">
          ...
          <div className="bg-white/70 backdrop-blur-lg rounded-2xl shadow-xl p-8 border-l-8 border-purple-400 w-full max-w-4xl mb-8 mx-auto">
            ...
            {teamMembers.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {teamMembers.map((member) => (
                  <div key={member._id} className="bg-white/50 backdrop-blur-lg rounded-xl p-4 border border-white/30 hover:shadow-lg transition-all duration-200">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center space-x-3">
          ...
          {/* Projects Section */}
          <div className="bg-white/70 backdrop-blur-lg rounded-2xl shadow-xl p-8 border-l-8 border-orange-400 w-full max-w-4xl mb-8 mx-auto">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                <div className="p-3 bg-gradient-to-r from-orange-500 to-red-500 rounded-xl shadow-lg">
                  <Briefcase className="w-5 h-5 text-white" />
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800">Assigned Projects</h3>
                  <p className="text-sm text-gray-600">Manage project teams</p>
                </div>
              </div>
            </div>
            ...
            {projects.length === 0 ? (
              ...
              <div className="space-y-4">
                {projects.map((project) => (
                  <div key={project._id} className="bg-white/50 backdrop-blur-lg rounded-xl p-4 border border-white/30 hover:shadow-lg transition-all duration-200">
                    <div className="flex items-center justify-between mb-3">
                      <div>
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-gray-500">Deadline: {new Date(project.deadline).toLocaleDateString()}</span>
                    </div>
                  </div>
                ))}
              </div>
