...
router.post('/apply', auth, checkRole(['developer', 'manager', 'designer', 'Business']), applyForLeave);

// @route   GET api/leaves/my-history
// @desc    Get my leave history
// @access  Private (Developer, Manager, Designer, Business)
router.get('/my-history', auth, checkRole(['developer', 'manager', 'designer', 'Business']), getMyLeaveHistory);
